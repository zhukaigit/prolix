...
/**
 * 博客地址：https://blog.csdn.net/lkforce/article/details/82466893
 */
public class TypeTest {
    public static void test (TypeTest p0,
                             List<TypeTest> p1,
    ...
    public static void main (String[] args) {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            if (oneMethod.getName().equals("test")) {
                ...
                //第六个参数，List<? extends TypeTest> p5
                Type type5 = types[5];
                ...
                //第七个参数，Map<? extends TypeTest,? super TypeTest> p6
                Type type6 = types[6];
